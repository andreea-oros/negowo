...
export const RequestButtonWrapper = styled.a`
  text-decoration: none;
  display:flex;
  align-items:center;
  justify-content: center;
...
export const ButtonText = styled.div`
  ...
  margin:0 10px;
  z-index: 1;
  :hover{    color:#A08B57; transition: 0.2s ease-in-out all}
...
export const SideMenuButtonLine = styled.span`
  ...
  left:14px;
  transition: all 0.3s;
  background-color: ${props=>(props.isOpen ? '#000':'#A08B57')};
  border-radius: 3px;
`;
